    ...
    <div class="row justify-content-start">
        ...
        <div class="col-4">
            <form class="form-signin" id="login" action="" method="post">
                ...
                <h1 class="h3 mb-3 font-weight-normal">Essenmarke</h1>
                <?php if(strlen($this->loginerror) > 0)echo "<p class='loginerror'>".$this->loginerror."</p>";?>
                <label for="benutzername" class="sr-only">Username</label>
            ...
            <form style='display:none;' class="form-signin" id="register" action="" method="post">
                ...
                <input type="text" id="benutzernameneu" name="benutzername" class="form-control" placeholder="Benutzername" required autofocus>
